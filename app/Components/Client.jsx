  ...
  return (  
    <div className={`${font.className} py-8 md:p-16 p-8 flex flex-col md:flex-row bg-black w-full`}>
        ...
        <section className='md:w-[50%] md:ml-8 flex flex-col justify-center items-start w-full'>
            ...
            <button onClick={openModal} data-aos="fade-up" className='btn-primary bg-opacity-100 hover:bg-opacity-100 bg-cards text-black hover:text-white hover:bg-card1 mt-6'>Get In Touch</button>
        </section>
