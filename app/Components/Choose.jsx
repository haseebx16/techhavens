    ...
    <div className={`${font.className} md:p-16 bg-black overflow-hidden z-10 p-8 flex flex-col md:flex-row md:justify-center md:items-center`} ref={sectionRef}>
        ...
        <section className='md:w-[50%]  pt-12 md:pt-0 w-full'>
            <div>
                ...
                <p className='text-md text-white mt-6'>We are a platform that offers amazing career opportunities to everyone who shakes our hand.</p>
                <p className='text-md text-white mt-6'>&#x2022;&nbsp; Vetted once, eligible for life</p>
                <p className='text-md text-white '>&#x2022;&nbsp; Exclusive Turing developer community</p>
                <p className='text-md text-white'>&#x2022;&nbsp; Income stability thanks to a 99% rematch rate</p>
                <div className='flex space-x-4'>
                    ...
                    <div className='bg-white text-black mt-6 p-4 rounded-md w-fit flex flex-col justify-center items-center'> 
                        <p className='text-3xl'>
