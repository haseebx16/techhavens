...
const page = () => {
  ...
  return (
    ...
    <div className={`${font.className} flex flex-col bg-black items-center md:items-center p-4`}>
        ...
        <p className="text-white max-w-xl mt-4"><span className="text-cards pt-4">Disclaimer:</span> By providing a telephone number and submitting the form you are consenting to be contacted by SMS text message & confirming that you're over 18. Message and data rates may apply. Reply STOP to opt out of further messaging</p>
